...
namespace Network {
    ...
    public:
        ...
        virtual std::size_t getInputContentSize() const = 0;
        virtual std::size_t getOutputContentSize() const = 0;
        virtual bool getInputContent(void *buf, std::size_t len, bool remove) const = 0;
        virtual bool getOutputContent(void *buf, std::size_t len, bool remove) const = 0;
